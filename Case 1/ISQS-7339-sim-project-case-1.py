...
MonthBudg = 9500 #Monthly Budget

SGICost = 10000 #9000 is discounted cost in Months 1 and 2

SunCost = 20000 #18750 is the discounted cost in Months 1 and 2
...
prob += sum(ServerCost[i]*x[i]*alpha for i in ServerCt) - sum(ServerCap[i]*x[i] for i in ServerCt),'Objective'
